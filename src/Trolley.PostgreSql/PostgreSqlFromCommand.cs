...
public class PostgreSqlFromCommand<T> : FromCommand<T>, IPostgreSqlFromCommand<T>
{
    ...
    public new IPostgreSqlFromCommand<T> Union(IQuery<T> subQuery)
        => base.Union(subQuery) as IPostgreSqlFromCommand<T>;
    public new IPostgreSqlFromCommand<T> Union(Expression<Func<IFromQuery, IQuery<T>>> subQueryExpr)
        => base.Union(subQueryExpr) as IPostgreSqlFromCommand<T>;
    public new IPostgreSqlFromCommand<T> UnionAll(IQuery<T> subQuery)
        => base.UnionAll(subQuery) as IPostgreSqlFromCommand<T>;
    public new IPostgreSqlFromCommand<T> UnionAll(Expression<Func<IFromQuery, IQuery<T>>> subQueryExpr)
        => base.UnionAll(subQueryExpr) as IPostgreSqlFromCommand<T>;
    public new IPostgreSqlFromCommand<T> UnionRecursive(Expression<Func<IFromQuery, IQuery<T>, IQuery<T>>> subQueryExpr)
        => base.UnionRecursive(subQueryExpr) as IPostgreSqlFromCommand<T>;
    public new IPostgreSqlFromCommand<T> UnionAllRecursive(Expression<Func<IFromQuery, IQuery<T>, IQuery<T>>> subQueryExpr)
        => base.UnionAllRecursive(subQueryExpr) as IPostgreSqlFromCommand<T>;
    #endregion

    #region WithTable
    public new IPostgreSqlFromCommand<T, TOther> WithTable<TOther>()
        => base.WithTable<TOther>() as IPostgreSqlFromCommand<T, TOther>;
    #endregion

    #region WithQuery
    public new IPostgreSqlFromCommand<T, TOther> WithQuery<TOther>(IQuery<TOther> subQuery)
        => base.WithQuery(subQuery) as IPostgreSqlFromCommand<T, TOther>;
    public new IPostgreSqlFromCommand<T, TOther> WithQuery<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr)
        => base.WithQuery(subQueryExpr) as IPostgreSqlFromCommand<T, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T, TOther> InnerJoin<TOther>(IQuery<TOther> subQuery, Expression<Func<T, TOther, bool>> joinOn)
        => base.InnerJoin(subQuery, joinOn) as IPostgreSqlFromCommand<T, TOther>;
    public new IPostgreSqlFromCommand<T, TOther> InnerJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T, TOther, bool>> joinOn)
        => base.InnerJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T, TOther> LeftJoin<TOther>(IQuery<TOther> subQuery, Expression<Func<T, TOther, bool>> joinOn)
        => base.LeftJoin(subQuery, joinOn) as IPostgreSqlFromCommand<T, TOther>;
    public new IPostgreSqlFromCommand<T, TOther> LeftJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T, TOther, bool>> joinOn)
        => base.LeftJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T, TOther> RightJoin<TOther>(IQuery<TOther> subQuery, Expression<Func<T, TOther, bool>> joinOn)
        => base.RightJoin(subQuery, joinOn) as IPostgreSqlFromCommand<T, TOther>;
    public new IPostgreSqlFromCommand<T, TOther> RightJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T, TOther, bool>> joinOn)
        => base.RightJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T> Where(bool condition, Expression<Func<T, bool>> ifPredicate, Expression<Func<T, bool>> elsePredicate = null)
        => base.Where(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T>;
    public new IPostgreSqlFromCommand<T> WherePredicate(Func<PredicateBuilder<T>, Expression<Func<T, bool>>> predicateInitializer)
        => base.WherePredicate(predicateInitializer) as IPostgreSqlFromCommand<T>;
    #endregion

    #region And
    public new IPostgreSqlFromCommand<T> And(Expression<Func<T, bool>> predicate)
        => this.And(true, predicate);
    public new IPostgreSqlFromCommand<T> And(bool condition, Expression<Func<T, bool>> ifPredicate, Expression<Func<T, bool>> elsePredicate = null)
        => base.And(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T>;
    public new IPostgreSqlFromCommand<T> AndPredicate(Func<PredicateBuilder<T>, Expression<Func<T, bool>>> predicateInitializer)
        => base.AndPredicate(predicateInitializer) as IPostgreSqlFromCommand<T>;
    #endregion

    #region Or
    public new IPostgreSqlFromCommand<T> Or(Expression<Func<T, bool>> predicate)
        => this.Or(true, predicate);
    public new IPostgreSqlFromCommand<T> Or(bool condition, Expression<Func<T, bool>> ifPredicate, Expression<Func<T, bool>> elsePredicate = null)
        => base.Or(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T>;
    public new IPostgreSqlFromCommand<T> OrPredicate(Func<PredicateBuilder<T>, Expression<Func<T, bool>>> predicateInitializer)
        => base.OrPredicate(predicateInitializer) as IPostgreSqlFromCommand<T>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T> OrderBy<TFields>(bool condition, Expression<Func<T, TFields>> fieldsExpr)
        => base.OrderBy(condition, fieldsExpr) as IPostgreSqlFromCommand<T>;
    ...
    public new IPostgreSqlFromCommand<T> OrderByDescending<TFields>(bool condition, Expression<Func<T, TFields>> fieldsExpr)
        => base.OrderByDescending(condition, fieldsExpr) as IPostgreSqlFromCommand<T>;
    public new IPostgreSqlFromCommand<T> OrderByDynamic(Func<OrderByBuilder<T>, Expression> fieldsGetter)
        => base.OrderByDynamic(fieldsGetter) as IPostgreSqlFromCommand<T>;
    #endregion

    #region Skip/Take/Page
    public new IPostgreSqlFromCommand<T> Skip(int offset)
        => base.Skip(offset) as IPostgreSqlFromCommand<T>;
    public new IPostgreSqlFromCommand<T> Take(int limit)
        => base.Take(limit) as IPostgreSqlFromCommand<T>;
    public new IPostgreSqlFromCommand<T> Page(int pageNumber, int pageSize)
        => base.Page(pageNumber, pageSize) as IPostgreSqlFromCommand<T>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T> Distinct()
        => base.Distinct() as IPostgreSqlFromCommand<T>;
    #endregion
...
public class PostgreSqlFromCommand<T1, T2> : FromCommand<T1, T2>, IPostgreSqlFromCommand<T1, T2>
{
    ...
    public new IPostgreSqlFromCommand<T1, T2> UseTableMap<TMasterSharding>(Func<string, string, string, string> tableNameGetter)
        => base.UseTableMap<TMasterSharding>(tableNameGetter) as IPostgreSqlFromCommand<T1, T2>;
    ...
    #region WithTable
    public new IPostgreSqlFromCommand<T1, T2, TOther> WithTable<TOther>()
        => base.WithTable<TOther>() as IPostgreSqlFromCommand<T1, T2, TOther>;
    #endregion

    #region WithQuery
    public new IPostgreSqlFromCommand<T1, T2, TOther> WithQuery<TOther>(IQuery<TOther> subQuery)
        => base.WithQuery(subQuery) as IPostgreSqlFromCommand<T1, T2, TOther>;
    public new IPostgreSqlFromCommand<T1, T2, TOther> WithQuery<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr)
        => base.WithQuery(subQueryExpr) as IPostgreSqlFromCommand<T1, T2, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, TOther> InnerJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, TOther, bool>> joinOn)
        => base.InnerJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, TOther> LeftJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, TOther, bool>> joinOn)
        => base.LeftJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, TOther> RightJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, TOther, bool>> joinOn)
        => base.RightJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2> Where(bool condition, Expression<Func<T1, T2, bool>> ifPredicate, Expression<Func<T1, T2, bool>> elsePredicate = null)
        => base.Where(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2>;
    public new IPostgreSqlFromCommand<T1, T2> WherePredicate(Func<PredicateBuilder<T1, T2>, Expression<Func<T1, T2, bool>>> predicateInitializer)
        => base.WherePredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2> And(bool condition, Expression<Func<T1, T2, bool>> ifPredicate = null, Expression<Func<T1, T2, bool>> elsePredicate = null)
        => base.And(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2>;
    public new IPostgreSqlFromCommand<T1, T2> AndPredicate(Func<PredicateBuilder<T1, T2>, Expression<Func<T1, T2, bool>>> predicateInitializer)
        => base.AndPredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2>;
    #endregion

    #region Or
    public new IPostgreSqlFromCommand<T1, T2> Or(Expression<Func<T1, T2, bool>> predicate)
        => this.Or(true, predicate);
    public new IPostgreSqlFromCommand<T1, T2> Or(bool condition, Expression<Func<T1, T2, bool>> ifPredicate = null, Expression<Func<T1, T2, bool>> elsePredicate = null)
        => base.Or(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2>;
    public new IPostgreSqlFromCommand<T1, T2> OrPredicate(Func<PredicateBuilder<T1, T2>, Expression<Func<T1, T2, bool>>> predicateInitializer)
        => base.OrPredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2> OrderBy<TFields>(bool condition, Expression<Func<T1, T2, TFields>> fieldsExpr)
        => base.OrderBy(condition, fieldsExpr) as IPostgreSqlFromCommand<T1, T2>;
    ...
    public new IPostgreSqlFromCommand<T1, T2> OrderByDescending<TFields>(bool condition, Expression<Func<T1, T2, TFields>> fieldsExpr)
        => base.OrderByDescending(condition, fieldsExpr) as IPostgreSqlFromCommand<T1, T2>;
    public new IPostgreSqlFromCommand<T1, T2> OrderByDynamic(Func<OrderByBuilder<T1, T2>, Expression> fieldsGetter)
        => base.OrderByDynamic(fieldsGetter) as IPostgreSqlFromCommand<T1, T2>;
    #endregion

    #region Skip/Take/Page
    public new IPostgreSqlFromCommand<T1, T2> Skip(int offset)
        => base.Skip(offset) as IPostgreSqlFromCommand<T1, T2>;
    public new IPostgreSqlFromCommand<T1, T2> Take(int limit)
        => base.Take(limit) as IPostgreSqlFromCommand<T1, T2>;
    public new IPostgreSqlFromCommand<T1, T2> Page(int pageNumber, int pageSize)
        => base.Page(pageNumber, pageSize) as IPostgreSqlFromCommand<T1, T2>;
    #endregion
...
public class PostgreSqlFromCommand<T1, T2, T3> : FromCommand<T1, T2, T3>, IPostgreSqlFromCommand<T1, T2, T3>
{
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3> UseTableMap<TMasterSharding>(Func<string, string, string, string> tableNameGetter)
        => base.UseTableMap<TMasterSharding>(tableNameGetter) as IPostgreSqlFromCommand<T1, T2, T3>;
    ...
    #region WithTable
    public new IPostgreSqlFromCommand<T1, T2, T3, TOther> WithTable<TOther>()
        => base.WithTable<TOther>() as IPostgreSqlFromCommand<T1, T2, T3, TOther>;
    #endregion

    #region WithQuery
    public new IPostgreSqlFromCommand<T1, T2, T3, TOther> WithQuery<TOther>(IQuery<TOther> subQuery)
        => base.WithQuery(subQuery) as IPostgreSqlFromCommand<T1, T2, T3, TOther>;
    public new IPostgreSqlFromCommand<T1, T2, T3, TOther> WithQuery<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr)
        => base.WithQuery(subQueryExpr) as IPostgreSqlFromCommand<T1, T2, T3, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, TOther> InnerJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, T3, TOther, bool>> joinOn)
        => base.InnerJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, T3, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, TOther> LeftJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, T3, TOther, bool>> joinOn)
        => base.LeftJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, T3, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, TOther> RightJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, T3, TOther, bool>> joinOn)
        => base.RightJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, T3, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3> Where(bool condition, Expression<Func<T1, T2, T3, bool>> ifPredicate, Expression<Func<T1, T2, T3, bool>> elsePredicate = null)
        => base.Where(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3>;
    public new IPostgreSqlFromCommand<T1, T2, T3> WherePredicate(Func<PredicateBuilder<T1, T2, T3>, Expression<Func<T1, T2, T3, bool>>> predicateInitializer)
        => base.WherePredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3> And(bool condition, Expression<Func<T1, T2, T3, bool>> ifPredicate = null, Expression<Func<T1, T2, T3, bool>> elsePredicate = null)
        => base.And(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3>;
    public new IPostgreSqlFromCommand<T1, T2, T3> AndPredicate(Func<PredicateBuilder<T1, T2, T3>, Expression<Func<T1, T2, T3, bool>>> predicateInitializer)
        => base.AndPredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3>;
    #endregion

    #region Or
    public new IPostgreSqlFromCommand<T1, T2, T3> Or(Expression<Func<T1, T2, T3, bool>> predicate)
        => this.Or(true, predicate);
    public new IPostgreSqlFromCommand<T1, T2, T3> Or(bool condition, Expression<Func<T1, T2, T3, bool>> ifPredicate = null, Expression<Func<T1, T2, T3, bool>> elsePredicate = null)
        => base.Or(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3>;
    public new IPostgreSqlFromCommand<T1, T2, T3> OrPredicate(Func<PredicateBuilder<T1, T2, T3>, Expression<Func<T1, T2, T3, bool>>> predicateInitializer)
        => base.OrPredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3> OrderBy<TFields>(bool condition, Expression<Func<T1, T2, T3, TFields>> fieldsExpr)
        => base.OrderBy(condition, fieldsExpr) as IPostgreSqlFromCommand<T1, T2, T3>;
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3> OrderByDescending<TFields>(bool condition, Expression<Func<T1, T2, T3, TFields>> fieldsExpr)
        => base.OrderByDescending(condition, fieldsExpr) as IPostgreSqlFromCommand<T1, T2, T3>;
    public new IPostgreSqlFromCommand<T1, T2, T3> OrderByDynamic(Func<OrderByBuilder<T1, T2, T3>, Expression> fieldsGetter)
        => base.OrderByDynamic(fieldsGetter) as IPostgreSqlFromCommand<T1, T2, T3>;
    #endregion

    #region Skip/Take/Page
    public new IPostgreSqlFromCommand<T1, T2, T3> Skip(int offset)
        => base.Skip(offset) as IPostgreSqlFromCommand<T1, T2, T3>;
    public new IPostgreSqlFromCommand<T1, T2, T3> Take(int limit)
        => base.Take(limit) as IPostgreSqlFromCommand<T1, T2, T3>;
    public new IPostgreSqlFromCommand<T1, T2, T3> Page(int pageNumber, int pageSize)
        => base.Page(pageNumber, pageSize) as IPostgreSqlFromCommand<T1, T2, T3>;
    #endregion
...
public class PostgreSqlFromCommand<T1, T2, T3, T4> : FromCommand<T1, T2, T3, T4>, IPostgreSqlFromCommand<T1, T2, T3, T4>
{
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> UseTableMap<TMasterSharding>(Func<string, string, string, string> tableNameGetter)
        => base.UseTableMap<TMasterSharding>(tableNameGetter) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    ...
    #region WithTable
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, TOther> WithTable<TOther>()
        => base.WithTable<TOther>() as IPostgreSqlFromCommand<T1, T2, T3, T4, TOther>;
    #endregion

    #region WithQuery
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, TOther> WithQuery<TOther>(IQuery<TOther> subQuery)
        => base.WithQuery(subQuery) as IPostgreSqlFromCommand<T1, T2, T3, T4, TOther>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, TOther> WithQuery<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr)
        => base.WithQuery(subQueryExpr) as IPostgreSqlFromCommand<T1, T2, T3, T4, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, TOther> InnerJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, T3, T4, TOther, bool>> joinOn)
        => base.InnerJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, T3, T4, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, TOther> LeftJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, T3, T4, TOther, bool>> joinOn)
        => base.LeftJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, T3, T4, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, TOther> RightJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, T3, T4, TOther, bool>> joinOn)
        => base.RightJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, T3, T4, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> Where(bool condition, Expression<Func<T1, T2, T3, T4, bool>> ifPredicate, Expression<Func<T1, T2, T3, T4, bool>> elsePredicate = null)
        => base.Where(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> WherePredicate(Func<PredicateBuilder<T1, T2, T3, T4>, Expression<Func<T1, T2, T3, T4, bool>>> predicateInitializer)
        => base.WherePredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> And(bool condition, Expression<Func<T1, T2, T3, T4, bool>> ifPredicate = null, Expression<Func<T1, T2, T3, T4, bool>> elsePredicate = null)
        => base.And(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> AndPredicate(Func<PredicateBuilder<T1, T2, T3, T4>, Expression<Func<T1, T2, T3, T4, bool>>> predicateInitializer)
        => base.AndPredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    #endregion

    #region Or
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> Or(Expression<Func<T1, T2, T3, T4, bool>> predicate)
        => this.Or(true, predicate);
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> Or(bool condition, Expression<Func<T1, T2, T3, T4, bool>> ifPredicate = null, Expression<Func<T1, T2, T3, T4, bool>> elsePredicate = null)
        => base.Or(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> OrPredicate(Func<PredicateBuilder<T1, T2, T3, T4>, Expression<Func<T1, T2, T3, T4, bool>>> predicateInitializer)
        => base.OrPredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> OrderBy<TFields>(bool condition, Expression<Func<T1, T2, T3, T4, TFields>> fieldsExpr)
        => base.OrderBy(condition, fieldsExpr) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> OrderByDescending<TFields>(bool condition, Expression<Func<T1, T2, T3, T4, TFields>> fieldsExpr)
        => base.OrderByDescending(condition, fieldsExpr) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> OrderByDynamic(Func<OrderByBuilder<T1, T2, T3, T4>, Expression> fieldsGetter)
        => base.OrderByDynamic(fieldsGetter) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    #endregion

    #region Skip/Take/Page
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> Skip(int offset)
        => base.Skip(offset) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> Take(int limit)
        => base.Take(limit) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4> Page(int pageNumber, int pageSize)
        => base.Page(pageNumber, pageSize) as IPostgreSqlFromCommand<T1, T2, T3, T4>;
    #endregion
...
public class PostgreSqlFromCommand<T1, T2, T3, T4, T5> : FromCommand<T1, T2, T3, T4, T5>, IPostgreSqlFromCommand<T1, T2, T3, T4, T5>
{
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> UseTableMap<TMasterSharding>(Func<string, string, string, string> tableNameGetter)
        => base.UseTableMap<TMasterSharding>(tableNameGetter) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    ...
    #region WithTable
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther> WithTable<TOther>()
        => base.WithTable<TOther>() as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther>;
    #endregion

    #region WithQuery
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther> WithQuery<TOther>(IQuery<TOther> subQuery)
        => base.WithQuery(subQuery) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther> WithQuery<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr)
        => base.WithQuery(subQueryExpr) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther> InnerJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, T3, T4, T5, TOther, bool>> joinOn)
        => base.InnerJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther> LeftJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, T3, T4, T5, TOther, bool>> joinOn)
        => base.LeftJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther> RightJoin<TOther>(Expression<Func<IFromQuery, IQuery<TOther>>> subQueryExpr, Expression<Func<T1, T2, T3, T4, T5, TOther, bool>> joinOn)
        => base.RightJoin(subQueryExpr, joinOn) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, TOther>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> Where(bool condition, Expression<Func<T1, T2, T3, T4, T5, bool>> ifPredicate, Expression<Func<T1, T2, T3, T4, T5, bool>> elsePredicate = null)
        => base.Where(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> WherePredicate(Func<PredicateBuilder<T1, T2, T3, T4, T5>, Expression<Func<T1, T2, T3, T4, T5, bool>>> predicateInitializer)
        => base.WherePredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> And(bool condition, Expression<Func<T1, T2, T3, T4, T5, bool>> ifPredicate = null, Expression<Func<T1, T2, T3, T4, T5, bool>> elsePredicate = null)
        => base.And(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> AndPredicate(Func<PredicateBuilder<T1, T2, T3, T4, T5>, Expression<Func<T1, T2, T3, T4, T5, bool>>> predicateInitializer)
        => base.AndPredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    #endregion

    #region Or
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> Or(Expression<Func<T1, T2, T3, T4, T5, bool>> predicate)
        => this.Or(true, predicate);
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> Or(bool condition, Expression<Func<T1, T2, T3, T4, T5, bool>> ifPredicate = null, Expression<Func<T1, T2, T3, T4, T5, bool>> elsePredicate = null)
        => base.Or(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> OrPredicate(Func<PredicateBuilder<T1, T2, T3, T4, T5>, Expression<Func<T1, T2, T3, T4, T5, bool>>> predicateInitializer)
        => base.OrPredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> OrderBy<TFields>(bool condition, Expression<Func<T1, T2, T3, T4, T5, TFields>> fieldsExpr)
        => base.OrderBy(condition, fieldsExpr) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> OrderByDescending<TFields>(bool condition, Expression<Func<T1, T2, T3, T4, T5, TFields>> fieldsExpr)
        => base.OrderByDescending(condition, fieldsExpr) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> OrderByDynamic(Func<OrderByBuilder<T1, T2, T3, T4, T5>, Expression> fieldsGetter)
        => base.OrderByDynamic(fieldsGetter) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    #endregion

    #region Skip/Take/Page
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> Skip(int offset)
        => base.Skip(offset) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> Take(int limit)
        => base.Take(limit) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5> Page(int pageNumber, int pageSize)
        => base.Page(pageNumber, pageSize) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5>;
    #endregion
...
public class PostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> : FromCommand<T1, T2, T3, T4, T5, T6>, IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>
{
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> UseTableMap<TMasterSharding>(Func<string, string, string, string> tableNameGetter)
        => base.UseTableMap<TMasterSharding>(tableNameGetter) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> Where(bool condition, Expression<Func<T1, T2, T3, T4, T5, T6, bool>> ifPredicate, Expression<Func<T1, T2, T3, T4, T5, T6, bool>> elsePredicate = null)
        => base.Where(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> WherePredicate(Func<PredicateBuilder<T1, T2, T3, T4, T5, T6>, Expression<Func<T1, T2, T3, T4, T5, T6, bool>>> predicateInitializer)
        => base.WherePredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> And(bool condition, Expression<Func<T1, T2, T3, T4, T5, T6, bool>> ifPredicate = null, Expression<Func<T1, T2, T3, T4, T5, T6, bool>> elsePredicate = null)
        => base.And(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> AndPredicate(Func<PredicateBuilder<T1, T2, T3, T4, T5, T6>, Expression<Func<T1, T2, T3, T4, T5, T6, bool>>> predicateInitializer)
        => base.AndPredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    #endregion

    #region Or
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> Or(Expression<Func<T1, T2, T3, T4, T5, T6, bool>> predicate)
        => this.Or(true, predicate);
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> Or(bool condition, Expression<Func<T1, T2, T3, T4, T5, T6, bool>> ifPredicate = null, Expression<Func<T1, T2, T3, T4, T5, T6, bool>> elsePredicate = null)
        => base.Or(condition, ifPredicate, elsePredicate) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> OrPredicate(Func<PredicateBuilder<T1, T2, T3, T4, T5, T6>, Expression<Func<T1, T2, T3, T4, T5, T6, bool>>> predicateInitializer)
        => base.OrPredicate(predicateInitializer) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    #endregion
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> OrderBy<TFields>(bool condition, Expression<Func<T1, T2, T3, T4, T5, T6, TFields>> fieldsExpr)
        => base.OrderBy(condition, fieldsExpr) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    ...
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> OrderByDescending<TFields>(bool condition, Expression<Func<T1, T2, T3, T4, T5, T6, TFields>> fieldsExpr)
        => base.OrderByDescending(condition, fieldsExpr) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> OrderByDynamic(Func<OrderByBuilder<T1, T2, T3, T4, T5, T6>, Expression> fieldsGetter)
        => base.OrderByDynamic(fieldsGetter) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    #endregion

    #region Skip/Take/Page
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> Skip(int offset)
        => base.Skip(offset) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> Take(int limit)
        => base.Take(limit) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    public new IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> Page(int pageNumber, int pageSize)
        => base.Page(pageNumber, pageSize) as IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6>;
    #endregion
