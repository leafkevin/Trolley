...
public interface IPostgreSqlCreate<TEntity> : ICreate<TEntity>
{
    ...
    /// <returns>返回插入对象</returns>
    new IPostgreSqlCreate<TEntity> UseTableBy(object field1Value, object field2Value = null);
    #endregion
    ...
    /// <returns>返回插入对象</returns>
    IPostgreSqlCreated<TEntity> WithBulkCopy(IEnumerable<TEntity> insertObjs, int? timeoutSeconds = null);
    #endregion
}
