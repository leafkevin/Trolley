...
public class SqliteContinuedCreate<TEntity> : ContinuedCreate<TEntity>, ISqliteContinuedCreate<TEntity>
{
    #region Properties
    ...
    #region Constructor
    public SqliteContinuedCreate(DbContext dbContext, ICreateVisitor visitor)
    ...
    public new ISqliteContinuedCreate<TEntity> WithBy<TInsertObject>(bool condition, TInsertObject insertObj)
        => base.WithBy(condition, insertObj) as ISqliteContinuedCreate<TEntity>;
    public new ISqliteContinuedCreate<TEntity> WithBy<TField>(Expression<Func<TEntity, TField>> fieldSelector, TField fieldValue)
        => this.WithBy(true, fieldSelector, fieldValue);
    public new ISqliteContinuedCreate<TEntity> WithBy<TField>(bool condition, Expression<Func<TEntity, TField>> fieldSelector, TField fieldValue)
        => base.WithBy(condition, fieldSelector, fieldValue) as ISqliteContinuedCreate<TEntity>;
    #endregion

    #region IgnoreFields
    public new ISqliteContinuedCreate<TEntity> IgnoreFields(params string[] fieldNames)
        => base.IgnoreFields(fieldNames) as ISqliteContinuedCreate<TEntity>;
    public new ISqliteContinuedCreate<TEntity> IgnoreFields<TFields>(Expression<Func<TEntity, TFields>> fieldsSelector)
        => base.IgnoreFields(fieldsSelector) as ISqliteContinuedCreate<TEntity>;
    #endregion

    #region OnlyFields
    public new ISqliteContinuedCreate<TEntity> OnlyFields(params string[] fieldNames)
        => base.OnlyFields(fieldNames) as ISqliteContinuedCreate<TEntity>;
    public new ISqliteContinuedCreate<TEntity> OnlyFields<TFields>(Expression<Func<TEntity, TFields>> fieldsSelector)
    ...
    #region Returning
    public ISqliteCreated<TEntity, TResult> Returning<TResult>(string fieldNames)
    {
