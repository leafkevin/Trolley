...
public class SqliteUpdated<TEntity> : Updated<TEntity>, ISqliteUpdated<TEntity>
{
    #region Properties
    public SqliteUpdateVisitor DialectVisitor { get; protected set; }
    public IOrmProvider OrmProvider => this.Visitor.OrmProvider;
    #endregion

    #region Constructor
    public SqliteUpdated(DbContext dbContext, IUpdateVisitor visitor)
