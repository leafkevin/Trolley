...
public class SqliteCreated<TEntity> : Created<TEntity>, ISqliteCreated<TEntity>
{
    #region Properties
    public SqliteCreateVisitor DialectVisitor { get; protected set; }
    #endregion

    #region Constructor
    public SqliteCreated(DbContext dbContext, ICreateVisitor visitor)
...
public class SqliteCreated<TEntity, TResult> : Created<TEntity>, ISqliteCreated<TEntity, TResult>
{
    #region Constructor
    public SqliteCreated(DbContext dbContext, ICreateVisitor visitor)
        : base(dbContext, visitor) { }
...
public class SqliteBulkCreated<TEntity, TResult> : Created<TEntity>, ISqliteBulkCreated<TEntity, TResult>
{
    #region Constructor
    public SqliteBulkCreated(DbContext dbContext, ICreateVisitor visitor)
        : base(dbContext, visitor) { }
    #endregion
    ...
    public new List<TResult> Execute()
    {
        ...
        (var isNeedClose, var connection, var command) = this.DbContext.UseMasterCommand();
        var dialectVisitor = this.Visitor as SqliteCreateVisitor;
