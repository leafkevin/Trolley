...
class SqliteTheaTransaction : ITheaTransaction
{
    ...
    public SqliteTheaTransaction(SQLiteTransaction transaction) : this(null, transaction) { }
    public SqliteTheaTransaction(ITheaConnection connection, SQLiteTransaction transaction)
    {
