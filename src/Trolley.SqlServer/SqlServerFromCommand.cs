...
public class SqlServerFromCommand<T> : FromCommand<T>, ISqlServerFromCommand<T>
{
    ...
    public new ISqlServerFromCommand<T> Union(Func<IFromQuery, IQuery<T>> subQuery)
    {
        base.UnionInternal(subQuery);
        return this;
    }
    ...
    public new ISqlServerFromCommand<T> UnionAll(Func<IFromQuery, IQuery<T>> subQuery)
    {
        base.UnionAllInternal(subQuery);
        return this;
    }
    ...
    public new ISqlServerFromCommand<T, TOther> RightJoin<TOther>(IQuery<TOther> subQuery, Expression<Func<T, TOther, bool>> joinOn)
        => base.RightJoin(joinOn) as ISqlServerFromCommand<T, TOther>;
    public new ISqlServerFromCommand<T, TOther> InnerJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T, TOther, bool>> joinOn)
        => base.InnerJoin(joinOn) as ISqlServerFromCommand<T, TOther>;
    public new ISqlServerFromCommand<T, TOther> LeftJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T, TOther, bool>> joinOn)
        => base.LeftJoin(joinOn) as ISqlServerFromCommand<T, TOther>;
    public new ISqlServerFromCommand<T, TOther> RightJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T, TOther, bool>> joinOn)
        => base.RightJoin(joinOn) as ISqlServerFromCommand<T, TOther>;
    #endregion
...
public class SqlServerFromCommand<T1, T2> : FromCommand<T1, T2>, ISqlServerFromCommand<T1, T2>
{
    ...
    public new ISqlServerFromCommand<T1, T2, TOther> InnerJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, TOther, bool>> joinOn)
        => base.InnerJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, TOther>;
    public new ISqlServerFromCommand<T1, T2, TOther> LeftJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, TOther, bool>> joinOn)
        => base.LeftJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, TOther>;
    public new ISqlServerFromCommand<T1, T2, TOther> RightJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, TOther, bool>> joinOn)
        => base.RightJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, TOther>;
    #endregion
...
public class SqlServerFromCommand<T1, T2, T3> : FromCommand<T1, T2, T3>, ISqlServerFromCommand<T1, T2, T3>
{
    ...
    public new ISqlServerFromCommand<T1, T2, T3, TOther> InnerJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, T3, TOther, bool>> joinOn)
        => base.InnerJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, T3, TOther>;
    public new ISqlServerFromCommand<T1, T2, T3, TOther> LeftJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, T3, TOther, bool>> joinOn)
        => base.LeftJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, T3, TOther>;
    public new ISqlServerFromCommand<T1, T2, T3, TOther> RightJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, T3, TOther, bool>> joinOn)
        => base.RightJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, T3, TOther>;
    #endregion
...
public class SqlServerFromCommand<T1, T2, T3, T4> : FromCommand<T1, T2, T3, T4>, ISqlServerFromCommand<T1, T2, T3, T4>
{
    ...
    public new ISqlServerFromCommand<T1, T2, T3, T4, TOther> InnerJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, T3, T4, TOther, bool>> joinOn)
        => base.InnerJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, T3, T4, TOther>;
    public new ISqlServerFromCommand<T1, T2, T3, T4, TOther> LeftJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, T3, T4, TOther, bool>> joinOn)
        => base.LeftJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, T3, T4, TOther>;
    public new ISqlServerFromCommand<T1, T2, T3, T4, TOther> RightJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, T3, T4, TOther, bool>> joinOn)
        => base.RightJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, T3, T4, TOther>;
    #endregion
...
public class SqlServerFromCommand<T1, T2, T3, T4, T5> : FromCommand<T1, T2, T3, T4, T5>, ISqlServerFromCommand<T1, T2, T3, T4, T5>
{
    ...
    public new ISqlServerFromCommand<T1, T2, T3, T4, T5, TOther> InnerJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, T3, T4, T5, TOther, bool>> joinOn)
        => base.InnerJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, T3, T4, T5, TOther>;
    public new ISqlServerFromCommand<T1, T2, T3, T4, T5, TOther> LeftJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, T3, T4, T5, TOther, bool>> joinOn)
        => base.LeftJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, T3, T4, T5, TOther>;
    public new ISqlServerFromCommand<T1, T2, T3, T4, T5, TOther> RightJoin<TOther>(Func<IFromQuery, IQuery<TOther>> subQuery, Expression<Func<T1, T2, T3, T4, T5, TOther, bool>> joinOn)
        => base.RightJoin(subQuery, joinOn) as ISqlServerFromCommand<T1, T2, T3, T4, T5, TOther>;
    #endregion
