...
public class SqlServerBulkUpdated<TEntity, TResult> : Updated<TEntity>, ISqlServerBulkUpdated<TEntity, TResult>
{
    #region Properties
    public SqlServerUpdateVisitor DialectVisitor { get; protected set; }
    public IOrmProvider OrmProvider => this.Visitor.OrmProvider;
    ...
    #region Constructor
    public SqlServerBulkUpdated(DbContext dbContext, IUpdateVisitor visitor)
        : base(dbContext, visitor)
    {
        this.DialectVisitor = this.Visitor as SqlServerUpdateVisitor;
    }
