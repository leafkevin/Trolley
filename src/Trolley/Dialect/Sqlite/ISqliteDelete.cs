...
public interface ISqliteDelete<TEntity> : IDelete<TEntity>
{
    #region Sharding
    /// <summary>
    ...
    new ISqliteDelete<TEntity> UseTable(params string[] tableNames);
    /// <summary>
    ...
    /// <returns>返回删除对象</returns>
    new ISqliteDelete<TEntity> UseTable(Func<string, bool> tableNamePredicate);
    /// <summary>
    ...
    /// <returns>返回删除对象</returns>
    new ISqliteDelete<TEntity> UseTableBy(object field1Value, object field2Value = null);
    /// <summary>
    ...
    /// <returns>返回删除对象</returns>
    new ISqliteDelete<TEntity> UseTableByRange(object beginFieldValue, object endFieldValue);
    /// <summary>
    ...
    /// <returns>返回删除对象</returns>
    new ISqliteDelete<TEntity> UseTableByRange(object fieldValue1, object fieldValue2, object fieldValue3);
    #endregion
    ...
    /// <returns>返回删除对象</returns>
    new ISqliteDelete<TEntity> UseTableSchema(string tableSchema);
    #endregion
    ...
    /// <returns>返回删除对象</returns>
    new ISqliteContinuedDelete<TEntity> Where(object keys);
    /// <summary>
    /// 删除满足表达式predicate条件的数据，不局限于主键条件，表达式predicate不能为null
    /// </summary>
    /// <param name="predicate">条件表达式，表达式predicate不能为null</param>
    /// <returns>返回删除对象</returns>
    new ISqliteContinuedDelete<TEntity> Where(Expression<Func<TEntity, bool>> predicate);
    /// <summary>
    ...
    /// <returns>返回删除对象</returns>
    new ISqliteContinuedDelete<TEntity> Where(bool condition, Expression<Func<TEntity, bool>> ifPredicate, Expression<Func<TEntity, bool>> elsePredicate = null);
    #endregion
}