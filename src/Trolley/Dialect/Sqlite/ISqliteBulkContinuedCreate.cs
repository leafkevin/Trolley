...
public interface ISqliteBulkContinuedCreate<TEntity> : IContinuedCreate<TEntity>
{
    ...
    ISqliteBulkCreated<TEntity, TResult> Output<TResult>(params string[] fieldNames);
    /// <summary>
    /// 返回插入后想要返回字段的内容
    /// </summary>
    /// <typeparam name="TResult">返回类型</typeparam>
    ...
    /// <returns>返回插入的部分字段</returns>
    ISqliteBulkCreated<TEntity, TResult> Output<TResult>(Expression<Func<TEntity, TResult>> fieldsSelector);
    #endregion
}