...
public interface ISqliteCreated<TEntity> : ICreated<TEntity> { }
public interface ISqliteCreated<TEntity, TResult> : ISqliteCreated<TEntity>
{
    #region Execute
    /// <summary>
    /// 执行插入操作，并返回插入行数
...
public interface ISqliteBulkCreated<TEntity, TResult> : ISqliteCreated<TEntity>
{
    #region Execute
    /// <summary>
    /// 执行插入操作，并返回插入行数
