...
public interface ISqliteUpdate<TEntity> : IUpdate<TEntity>
{
    #region Sharding
    /// <summary>
    ...
    new ISqliteUpdate<TEntity> UseTable(params string[] tableNames);
    /// <summary>
    ...
    /// <returns>返回更新对象</returns>
    new ISqliteUpdate<TEntity> UseTable(Func<string, bool> tableNamePredicate);
    /// <summary>
    ...
    /// <returns>返回更新对象</returns>
    new ISqliteUpdate<TEntity> UseTableBy(object field1Value, object field2Value = null);
    /// <summary>
    ...
    /// <returns>返回更新对象</returns>
    new ISqliteUpdate<TEntity> UseTableByRange(object beginFieldValue, object endFieldValue);
    /// <summary>
    ...
    /// <returns>返回更新对象</returns>
    new ISqliteUpdate<TEntity> UseTableByRange(object fieldValue1, object fieldValue2, object fieldValue3);
    #endregion
    ...
    /// <returns>返回更新对象</returns>
    new ISqliteContinuedUpdate<TEntity> SetBulk<TUpdateObj>(IEnumerable<TUpdateObj> updateObjs, int bulkCount = 500);
    #endregion
    ...
    ISqliteUpdated<TEntity> SetBulkCopy(IEnumerable updateObjs, int? timeoutSeconds = null);
    #endregion
}