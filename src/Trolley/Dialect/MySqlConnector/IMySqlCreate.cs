...
public interface IMySqlCreate<TEntity> : ICreate<TEntity>
{
    ...
    /// <returns>返回插入对象</returns>
    new IMySqlCreate<TEntity> UseTableBy(object fieldValue);
    /// <summary>
    ...
    /// <returns>返回插入对象</returns>
    new IMySqlCreate<TEntity> UseTableBy(object field1Value, object field2Value);
    /// <summary>
    ...
    /// <returns>返回插入对象</returns>
    new IMySqlCreate<TEntity> UseTableBy(object field1Value, object field2Value, object field3Value);
    /// <summary>
    ...
    new IMySqlCreate<TEntity> UseTableBy<TInsertObj>(Func<string, TInsertObj, string> tableNameGetter);
    #endregion
