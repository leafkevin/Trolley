...
public interface IMySqlUpdate<TEntity> : IUpdate<TEntity>
{
    ...
    /// <returns>返回更新对象</returns>
    new IMySqlUpdate<TEntity> UseTable(Expression<Func<TEntity, object>> dependOnFieldValuesSelector);
    /// <summary>
    ...
    /// <returns>返回更新对象</returns>
    new IMySqlUpdate<TEntity> UseTableByRange(params object[] fieldValues);
    #endregion
    ...
    /// <returns>返回更新对象</returns>
    new IMySqlUpdate<TEntity> UseTableSchema(string tableSchema);
    #endregion
