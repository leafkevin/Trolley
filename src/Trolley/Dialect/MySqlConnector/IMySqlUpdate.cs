...
public interface IMySqlUpdate<TEntity> : IUpdate<TEntity>
{
    ...
    /// <returns>返回更新对象</returns>
    new IMySqlUpdate<TEntity> UseTableBy(object field1Value, object field2Value = null);
    /// <summary>
    ...
    /// <returns>返回更新对象</returns>
    new IMySqlUpdate<TEntity> UseTableByRange(object fieldValue1, object fieldValue2, object fieldValue3);
    #endregion
    ...
    IMySqlUpdated<TEntity> SetBulkCopy(IEnumerable updateObjs, int? timeoutSeconds = null);
    #endregion
}