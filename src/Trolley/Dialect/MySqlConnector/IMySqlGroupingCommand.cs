...
public interface IMySqlGroupingCommandBase<TGrouping> : IGroupingCommandBase<TGrouping>
{
    ...
    new IMySqlFromContinuedCreate<TGrouping> Select();
    /// <summary>
...
public interface IMySqlGroupingCommand<T, TGrouping> : IGroupingCommand<T, TGrouping>, IMySqlGroupingCommandBase<TGrouping>
{
    ...
    /// <returns>返回分组查询对象</returns>
    new IMySqlFromContinuedCreate<TTarget> Select<TTarget>(Expression<Func<IGroupingAggregate<TGrouping>, T, TTarget>> fieldsExpr);
}
/// <summary>
/// 分组查询对象
/// </summary>
...
public interface IMySqlGroupingCommand<T1, T2, TGrouping> : IGroupingCommand<T1, T2, TGrouping>, IGroupingCommandBase<TGrouping>
{
    ...
    /// <param name="fieldsExpr">字段选择表达式，单个字段或多个字段的匿名对象</param>
    /// <returns>返回分组查询对象</returns>
    new IMySqlFromContinuedCreate<TTarget> Select<TTarget>(Expression<Func<IGroupingAggregate<TGrouping>, T1, T2, TTarget>> fieldsExpr);
}
/// <summary>
/// 分组查询对象
/// </summary>
...
public interface IMySqlGroupingCommand<T1, T2, T3, TGrouping> : IGroupingCommand<T1, T2, T3, TGrouping>, IMySqlGroupingCommandBase<TGrouping>
{
    ...
    /// <param name="fieldsExpr">字段选择表达式，单个字段或多个字段的匿名对象</param>
    /// <returns>返回分组查询对象</returns>
    new IMySqlFromContinuedCreate<TTarget> Select<TTarget>(Expression<Func<IGroupingAggregate<TGrouping>, T1, T2, T3, TTarget>> fieldsExpr);
}
/// <summary>
/// 分组查询对象
/// </summary>
...
public interface IMySqlGroupingCommand<T1, T2, T3, T4, TGrouping> : IGroupingCommand<T1, T2, T3, T4, TGrouping>, IMySqlGroupingCommandBase<TGrouping>
{
    ...
    /// <param name="fieldsExpr">字段选择表达式，单个字段或多个字段的匿名对象</param>
    /// <returns>返回分组查询对象</returns>
    new IMySqlFromContinuedCreate<TTarget> Select<TTarget>(Expression<Func<IGroupingAggregate<TGrouping>, T1, T2, T3, T4, TTarget>> fieldsExpr);
}
/// <summary>
/// 分组查询对象
/// </summary>
...
public interface IMySqlGroupingCommand<T1, T2, T3, T4, T5, TGrouping> : IGroupingCommand<T1, T2, T3, T4, T5, TGrouping>, IMySqlGroupingCommandBase<TGrouping>
{
    ...
    /// <param name="fieldsExpr">字段选择表达式，单个字段或多个字段的匿名对象</param>
    /// <returns>返回分组查询对象</returns>
    new IMySqlFromContinuedCreate<TTarget> Select<TTarget>(Expression<Func<IGroupingAggregate<TGrouping>, T1, T2, T3, T4, T5, TTarget>> fieldsExpr);
}
/// <summary>
/// 分组查询对象
/// </summary>
...
public interface IMySqlGroupingCommand<T1, T2, T3, T4, T5, T6, TGrouping> : IGroupingCommand<T1, T2, T3, T4, T5, T6, TGrouping>, IMySqlGroupingCommandBase<TGrouping>
{
    ...
    /// <param name="fieldsExpr">字段选择表达式，单个字段或多个字段的匿名对象</param>
    /// <returns>返回分组查询对象</returns>
    new IMySqlFromContinuedCreate<TTarget> Select<TTarget>(Expression<Func<IGroupingAggregate<TGrouping>, T1, T2, T3, T4, T5, T6, TTarget>> fieldsExpr);
}