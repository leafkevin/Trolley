...
public interface IPostgreSqlFromCommand<T> : IFromCommand<T>
{
    ...
    /// <returns>返回查询对象</returns>
    new IPostgreSqlFromCommand<TTarget> SelectTo<TTarget>(Expression<Func<T, TTarget>> specialMemberSelector = null);
    /// <summary>
...
public interface IPostgreSqlFromCommand<T1, T2> : IFromCommand<T1, T2>
{
    ...
    /// <param name="specialMemberSelector">特殊成员赋值表达式，通常是重名字段或是不存在的字段赋值</param>
    /// <returns>返回查询对象</returns>
    new IPostgreSqlFromCommand<TTarget> SelectTo<TTarget>(Expression<Func<T1, T2, TTarget>> specialMemberSelector = null);
    #endregion
}
public interface IPostgreSqlFromCommand<T1, T2, T3> : IFromCommand<T1, T2, T3>
{
    ...
    /// <param name="specialMemberSelector">特殊成员赋值表达式，通常是重名字段或是不存在的字段赋值</param>
    /// <returns>返回查询对象</returns>
    new IPostgreSqlFromCommand<TTarget> SelectTo<TTarget>(Expression<Func<T1, T2, T3, TTarget>> specialMemberSelector = null);
    #endregion
}
public interface IPostgreSqlFromCommand<T1, T2, T3, T4> : IFromCommand<T1, T2, T3, T4>
{
    ...
    /// <param name="specialMemberSelector">特殊成员赋值表达式，通常是重名字段或是不存在的字段赋值</param>
    /// <returns>返回查询对象</returns>
    new IPostgreSqlFromCommand<TTarget> SelectTo<TTarget>(Expression<Func<T1, T2, T3, T4, TTarget>> specialMemberSelector = null);
    #endregion
}
public interface IPostgreSqlFromCommand<T1, T2, T3, T4, T5> : IFromCommand<T1, T2, T3, T4, T5>
{
    ...
    /// <param name="specialMemberSelector">特殊成员赋值表达式，通常是重名字段或是不存在的字段赋值</param>
    /// <returns>返回查询对象</returns>
    new IPostgreSqlFromCommand<TTarget> SelectTo<TTarget>(Expression<Func<T1, T2, T3, T4, T5, TTarget>> specialMemberSelector = null);
    #endregion
}
public interface IPostgreSqlFromCommand<T1, T2, T3, T4, T5, T6> : IFromCommand<T1, T2, T3, T4, T5, T6>
{
    ...
    /// <param name="specialMemberSelector">特殊成员赋值表达式，通常是重名字段或是不存在的字段赋值</param>
    /// <returns>返回查询对象</returns>
    new IPostgreSqlFromCommand<TTarget> SelectTo<TTarget>(Expression<Func<T1, T2, T3, T4, T5, T6, TTarget>> specialMemberSelector = null);
    #endregion
}