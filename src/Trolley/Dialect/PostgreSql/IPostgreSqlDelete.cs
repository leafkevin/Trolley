...
public interface IPostgreSqlDelete<TEntity> : IDelete<TEntity>
{
    ...
    /// <returns>返回删除对象</returns>
    new IPostgreSqlDelete<TEntity> UseTableBy(object fieldValue);
    /// <summary>
    ...
    /// <returns>返回删除对象</returns>
    new IPostgreSqlDelete<TEntity> UseTableBy(object field1Value, object field2Value);
    /// <summary>
    ...
    /// <returns>返回删除对象</returns>
    new IPostgreSqlDelete<TEntity> UseTableBy(object field1Value, object field2Value, object field3Value);
    /// <summary>
