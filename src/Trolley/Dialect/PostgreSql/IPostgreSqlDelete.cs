...
public interface IPostgreSqlDelete<TEntity> : IDelete<TEntity>
{
    ...
    /// <returns>返回删除对象</returns>
    new IPostgreSqlDelete<TEntity> UseTableBy(object field1Value, object field2Value = null);
    /// <summary>
    ...
    /// <returns>返回删除对象</returns>
    new IPostgreSqlDelete<TEntity> UseTableByRange(object fieldValue1, object fieldValue2, object fieldValue3);
    #endregion
