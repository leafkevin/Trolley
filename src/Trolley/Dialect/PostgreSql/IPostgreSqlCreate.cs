...
public interface IPostgreSqlCreate<TEntity> : ICreate<TEntity>
{
    ...
    /// <returns>返回插入对象</returns>
    new IPostgreSqlCreate<TEntity> UseTableBy(object fieldValue);
    /// <summary>
    ...
    /// <returns>返回插入对象</returns>
    new IPostgreSqlCreate<TEntity> UseTableBy(object field1Value, object field2Value);
    /// <summary>
    ...
    /// <returns>返回插入对象</returns>
    new IPostgreSqlCreate<TEntity> UseTableBy(object field1Value, object field2Value, object field3Value);
    /// <summary>
    ...
    new IPostgreSqlCreate<TEntity> UseTableBy<TInsertObj>(Func<string, TInsertObj, string> tableNameGetter);
    #endregion
