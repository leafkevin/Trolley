...
public interface IPostgreSqlUpdate<TEntity> : IUpdate<TEntity>
{
    ...
    /// <returns>返回更新对象</returns>
    new IPostgreSqlUpdate<TEntity> UseTableBy(object field1Value, object field2Value = null);
    /// <summary>
    ...
    /// <returns>返回更新对象</returns>
    new IPostgreSqlUpdate<TEntity> UseTableByRange(object fieldValue1, object fieldValue2, object fieldValue3);
    #endregion
