...
public interface IPostgreSqlIncludableQuery<T, TMember> : IIncludableQuery<T, TMember>
{
    ...
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
...
public interface IPostgreSqlIncludableQuery<T1, T2, TMember> : IIncludableQuery<T1, T2, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, TMember> : IIncludableQuery<T1, T2, T3, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, TMember> : IIncludableQuery<T1, T2, T3, T4, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, TMember> : IIncludableQuery<T1, T2, T3, T4, T5, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, TMember> : IIncludableQuery<T1, T2, T3, T4, T5, T6, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, TMember> : IIncludableQuery<T1, T2, T3, T4, T5, T6, T7, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, TMember> : IIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, TMember> : IIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TMember> : IIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TMember> : IIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TMember> : IIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TMember> : IIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TMember> : IIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
...
public interface IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TMember> : IIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TMember>
{
    ...
    /// <param name="tableNameGetter">当前表分表名获取委托</param>
    /// <returns>返回导航属性查询对象</returns>
    new IPostgreSqlIncludableQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15, TMember> UseTable<TMasterSharding>(Func<string, string, string, string> tableNameGetter);
    /// <summary>
    /// 根据字段值确定T表分表名，最多支持2个字段，字段值的顺序与配置的字段顺序保持一致，可多次调用
    /// </summary>
    /// <param name="field1Value">字段1值</param>
