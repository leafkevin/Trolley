...
public interface ISqlServerContinuedUpdate<TEntity> : IContinuedUpdate<TEntity>
{
    #region Set
    /// <summary>
    ...
    /// <returns></returns>
    new ISqlServerContinuedUpdate<TEntity> IgnoreFields<TFields>(Expression<Func<TEntity, TFields>> fieldsSelector);
    #endregion
    ...
    /// <param name="fieldNames">忽略更新的字段列表</param>
    /// <returns>返回更新对象</returns>
    new ISqlServerContinuedUpdate<TEntity> OnlyFields(params string[] fieldNames);
    /// <summary>
    ...
    /// <param name="fieldsSelector">字段选择表达式，支持MemberAccess、New或MemberInit类型表达式</param>
    /// <returns>返回更新对象</returns>
    new ISqlServerContinuedUpdate<TEntity> OnlyFields<TFields>(Expression<Func<TEntity, TFields>> fieldsSelector);
    #endregion
    ...
    /// <returns>返回更新对象</returns>
    new ISqlServerUpdated<TEntity> Where<TWhereObj>(TWhereObj whereObj);
    /// <summary>
...
public interface ISqlServerBulkContinuedUpdate<TEntity> : IBulkContinuedUpdate<TEntity>
{
    ...
    /// <param name="fieldValue">字段值，固定值</param>
    /// <returns>返回更新对象</returns>
    new ISqlServerBulkContinuedUpdate<TEntity> Set<TField>(bool condition, Expression<Func<TEntity, TField>> fieldSelector, TField fieldValue);
    #endregion
    ...
    /// <param name="fieldsSelector">字段选择表达式，支持MemberAccess、New或MemberInit类型表达式</param>
    /// <returns></returns>
    new ISqlServerBulkContinuedUpdate<TEntity> IgnoreFields<TFields>(Expression<Func<TEntity, TFields>> fieldsSelector);
    #endregion
    ...
    /// <param name="fieldNames">忽略更新的字段列表</param>
    /// <returns>返回更新对象</returns>
    new ISqlServerBulkContinuedUpdate<TEntity> OnlyFields(params string[] fieldNames);
    /// <summary>
    /// 只更新指定字段，如：.OnlyFields(f =&gt; new { f.Name, f.Gender}); .OnlyFields(f =&gt; f.Name);
    /// </summary>
    /// <typeparam name="TFields">字段类型</typeparam>
    /// <param name="fieldsSelector">字段选择表达式，支持MemberAccess、New或MemberInit类型表达式</param>
    /// <returns>返回更新对象</returns>
    new ISqlServerBulkContinuedUpdate<TEntity> OnlyFields<TFields>(Expression<Func<TEntity, TFields>> fieldsSelector);
    #endregion
