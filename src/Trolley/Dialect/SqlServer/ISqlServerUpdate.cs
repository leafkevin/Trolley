...
public interface ISqlServerUpdate<TEntity> : IUpdate<TEntity>
{
    ...
    /// <returns>返回更新对象</returns>
    new ISqlServerUpdate<TEntity> UseTable(Expression<Func<TEntity, object>> dependOnFieldValuesSelector);
    /// <summary>
    ...
    new ISqlServerUpdate<TEntity> UseTable<TUpdateObj>(Func<string, TUpdateObj, string> tableNameGetter);
    /// <summary>
    ...
    /// <returns>返回更新对象</returns>
    new ISqlServerUpdate<TEntity> UseTableBy(params object[] fieldValues);
    /// <summary>
