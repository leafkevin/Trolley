...
public class FromCommand<T> : FromCommand, IFromCommand<T>
{
    ...
    public virtual IFromCommand<T> UseTableByRange(params object[] fieldValues)
    {
    ...
    #region Where
    public virtual IFromCommand<T> Where(Expression<Func<T, bool>> predicate) => this.And(predicate);
...
public class FromCommand<T1, T2> : FromCommand, IFromCommand<T1, T2>
{
    ...
    #region Where
    public virtual IFromCommand<T1, T2> Where(Expression<Func<T1, T2, bool>> predicate) => this.And(predicate);
...
public class FromCommand<T1, T2, T3> : FromCommand, IFromCommand<T1, T2, T3>
{
    ...
    #region Where
    public virtual IFromCommand<T1, T2, T3> Where(Expression<Func<T1, T2, T3, bool>> predicate) => this.And(predicate);
...
public class FromCommand<T1, T2, T3, T4> : FromCommand, IFromCommand<T1, T2, T3, T4>
{
    ...
    #region Where
    public virtual IFromCommand<T1, T2, T3, T4> Where(Expression<Func<T1, T2, T3, T4, bool>> predicate) => this.And(predicate);
...
public class FromCommand<T1, T2, T3, T4, T5> : FromCommand, IFromCommand<T1, T2, T3, T4, T5>
{
    ...
    #region Where
    public virtual IFromCommand<T1, T2, T3, T4, T5> Where(Expression<Func<T1, T2, T3, T4, T5, bool>> predicate) => this.And(predicate);
...
public class FromCommand<T1, T2, T3, T4, T5, T6> : FromCommand, IFromCommand<T1, T2, T3, T4, T5, T6>
{
    ...
    #region Where
    public virtual IFromCommand<T1, T2, T3, T4, T5, T6> Where(Expression<Func<T1, T2, T3, T4, T5, T6, bool>> predicate) => this.And(predicate);
