...
public class MultiIncludableQuery<T, TMember> : MultiQuery<T>, IMultiIncludableQuery<T, TMember>
{
    ...
    {
        this.Visitor.UseTable(TableShardingType.ReadOnly, this.IsIncludeMany, tableNames);
        return this;
    }
    public new IMultiIncludableQuery<T, TMember> UseTableMap(Func<string, string, string, string> tableNameGetter)
    {
        this.Visitor.UseTableMap(TableShardingType.ReadOnly, this.IsIncludeMany, tableNameGetter);
        return this;
    }
    public new IMultiIncludableQuery<T, TMember> UseTableBy(params object[] fieldValues)
    {
        this.Visitor.UseTableBy(TableShardingType.ReadOnly, this.IsIncludeMany, fieldValues);
        return this;
    }
    public new IMultiIncludableQuery<T, TMember> UseTableByRange(params object[] fieldValues)
    {
        this.Visitor.UseTableByRange(TableShardingType.ReadOnly, this.IsIncludeMany, fieldValues);
        return this;
    }
