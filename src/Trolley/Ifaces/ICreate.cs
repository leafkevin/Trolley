...
public interface IContinuedCreate<TEntity>
{
    ...
    /// 带条件部分字段插入
    /// </summary>
    /// <typeparam name="TInsertObject"></typeparam>
...
public interface IContinuedCreate<TEntity, TSource>
{
    ...
    IContinuedCreate<TEntity, TSource> And(bool condition, Expression<Func<TSource, bool>> predicate);
    int Execute();
    Task<int> ExecuteAsync(CancellationToken cancellationToken = default);
    string ToSql(out List<IDbDataParameter> dbParameters);
}
public interface IContinuedCreate<TEntity, T1, T2>
{
    ...
    IContinuedCreate<TEntity, T1, T2> And(bool condition, Expression<Func<T1, T2, bool>> predicate);
    int Execute();
    Task<int> ExecuteAsync(CancellationToken cancellationToken = default);
    string ToSql(out List<IDbDataParameter> dbParameters);
}
public interface IContinuedCreate<TEntity, T1, T2, T3>
{
    ...
    IContinuedCreate<TEntity, T1, T2, T3> And(bool condition, Expression<Func<T1, T2, T3, bool>> predicate);
    int Execute();
    Task<int> ExecuteAsync(CancellationToken cancellationToken = default);
    string ToSql(out List<IDbDataParameter> dbParameters);
}
public interface IContinuedCreate<TEntity, T1, T2, T3, T4>
{
    ...
    IContinuedCreate<TEntity, T1, T2, T3, T4> And(bool condition, Expression<Func<T1, T2, T3, T4, bool>> predicate);
    int Execute();
    Task<int> ExecuteAsync(CancellationToken cancellationToken = default);
    string ToSql(out List<IDbDataParameter> dbParameters);
}
public interface IContinuedCreate<TEntity, T1, T2, T3, T4, T5>
{
    ...
    IContinuedCreate<TEntity, T1, T2, T3, T4, T5> And(bool condition, Expression<Func<T1, T2, T3, T4, T5, bool>> predicate);
    int Execute();
    Task<int> ExecuteAsync(CancellationToken cancellationToken = default);
    string ToSql(out List<IDbDataParameter> dbParameters);
}