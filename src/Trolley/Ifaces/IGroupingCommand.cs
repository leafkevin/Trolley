...
/// 分组查询对象
/// </summary>
/// <typeparam name="TTarget">分组后的对象类型</typeparam>
public interface IGroupingCommand<TTarget>
{
    /// <summary>
    /// 使用分组后对象直接返回
    /// </summary>
    /// <returns>返回分组后对象</returns>
    IFromCommand<TTarget> Select();
}
/// <summary>
/// 分组查询对象
/// </summary>
...
public interface IGroupingCommand<T, TGrouping> : IGroupingCommand<TGrouping>
{
    /// <summary>
    ...
    /// <returns>返回查询对象</returns>
    IGroupingCommand<T, TGrouping> OrderByDynamic(Func<OrderByBuilder<IGroupingAggregate<TGrouping>, T>, Expression> fieldsGetter);
    /// <summary>
...
/// <typeparam name="TGrouping">分组后对象类型</typeparam>
public interface IGroupingCommand<T1, T2, TGrouping> : IGroupingCommand<TGrouping>
{
    /// <summary>
    /// Having操作，如: .Having((x, a, ...) => x.Sum(a.Amount) > 500)
    /// </summary>
    ...
    /// <param name="fieldsGetter">排序字段选择器，需调用Build方法，返回排序字段表达式</param>
    /// <returns>返回查询对象</returns>
    IGroupingCommand<T1, T2, TGrouping> OrderByDynamic(Func<OrderByBuilder<IGroupingAggregate<TGrouping>, T1, T2>, Expression> fieldsGetter);
    /// <summary>
    /// 选择指定字段返回，可以是单个或多个字段的匿名对象，如：
...
/// <typeparam name="TGrouping">分组后对象类型</typeparam>
public interface IGroupingCommand<T1, T2, T3, TGrouping> : IGroupingCommand<TGrouping>
{
    /// <summary>
    /// Having操作，如: .Having((x, a, ...) => x.Sum(a.Amount) > 500)
    /// </summary>
    ...
    /// <param name="fieldsGetter">排序字段选择器，需调用Build方法，返回排序字段表达式</param>
    /// <returns>返回查询对象</returns>
    IGroupingCommand<T1, T2, T3, TGrouping> OrderByDynamic(Func<OrderByBuilder<IGroupingAggregate<TGrouping>, T1, T2, T3>, Expression> fieldsGetter);
    /// <summary>
    /// 选择指定字段返回，可以是单个或多个字段的匿名对象，如：
    /// <code> .Select((x, a, ...) =&gt; new { x.Grouping, TotalAmount = x.Sum(a.Amount) }) 或是 .Select((x, a, ...) =&gt; a.Id)</code>
    /// </summary>
...
/// <typeparam name="TGrouping">分组后对象类型</typeparam>
public interface IGroupingCommand<T1, T2, T3, T4, TGrouping> : IGroupingCommand<TGrouping>
{
    /// <summary>
    /// Having操作，如: .Having((x, a, ...) => x.Sum(a.Amount) > 500)
    /// </summary>
    ...
    /// <param name="fieldsGetter">排序字段选择器，需调用Build方法，返回排序字段表达式</param>
    /// <returns>返回查询对象</returns>
    IGroupingCommand<T1, T2, T3, T4, TGrouping> OrderByDynamic(Func<OrderByBuilder<IGroupingAggregate<TGrouping>, T1, T2, T3, T4>, Expression> fieldsGetter);
    /// <summary>
    /// 选择指定字段返回，可以是单个或多个字段的匿名对象，如：
    /// <code> .Select((x, a, ...) =&gt; new { x.Grouping, TotalAmount = x.Sum(a.Amount) }) 或是 .Select((x, a, ...) =&gt; a.Id)</code>
    /// </summary>
...
/// <typeparam name="TGrouping">分组后对象类型</typeparam>
public interface IGroupingCommand<T1, T2, T3, T4, T5, TGrouping> : IGroupingCommand<TGrouping>
{
    /// <summary>
    /// Having操作，如: .Having((x, a, ...) => x.Sum(a.Amount) > 500)
    /// </summary>
    ...
    /// <param name="fieldsGetter">排序字段选择器，需调用Build方法，返回排序字段表达式</param>
    /// <returns>返回查询对象</returns>
    IGroupingCommand<T1, T2, T3, T4, T5, TGrouping> OrderByDynamic(Func<OrderByBuilder<IGroupingAggregate<TGrouping>, T1, T2, T3, T4, T5>, Expression> fieldsGetter);
    /// <summary>
    /// 选择指定字段返回，可以是单个或多个字段的匿名对象，如：
    /// <code> .Select((x, a, ...) =&gt; new { x.Grouping, TotalAmount = x.Sum(a.Amount) }) 或是 .Select((x, a, ...) =&gt; a.Id)</code>
    /// </summary>
...
/// <typeparam name="TGrouping">分组后对象类型</typeparam>
public interface IGroupingCommand<T1, T2, T3, T4, T5, T6, TGrouping> : IGroupingCommand<TGrouping>
{
    /// <summary>
    /// Having操作，如: .Having((x, a, ...) => x.Sum(a.Amount) > 500)
    /// </summary>
    ...
    /// <param name="fieldsGetter">排序字段选择器，需调用Build方法，返回排序字段表达式</param>
    /// <returns>返回查询对象</returns>
    IGroupingCommand<T1, T2, T3, T4, T5, T6, TGrouping> OrderByDynamic(Func<OrderByBuilder<IGroupingAggregate<TGrouping>, T1, T2, T3, T4, T5, T6>, Expression> fieldsGetter);
    /// <summary>
    /// 选择指定字段返回，可以是单个或多个字段的匿名对象，如：
    /// <code> .Select((x, a, ...) =&gt; new { x.Grouping, TotalAmount = x.Sum(a.Amount) }) 或是 .Select((x, a, ...) =&gt; a.Id)</code>
    /// </summary>
