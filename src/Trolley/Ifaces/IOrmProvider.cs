...
public interface IOrmProvider
{
    ...
    IFromCommand<TEntity, T> NewFromCommand<TEntity, T>(DbContext dbContext, IQueryVisitor visitor);
    IFromCommand<TEntity, T1, T2> NewFromCommand<TEntity, T1, T2>(DbContext dbContext, IQueryVisitor visitor);
    IFromCommand<TEntity, T1, T2, T3> NewFromCommand<TEntity, T1, T2, T3>(DbContext dbContext, IQueryVisitor visitor);
    IFromCommand<TEntity, T1, T2, T3, T4> NewFromCommand<TEntity, T1, T2, T3, T4>(DbContext dbContext, IQueryVisitor visitor);
    IFromCommand<TEntity, T1, T2, T3, T4, T5> NewFromCommand<TEntity, T1, T2, T3, T4, T5>(DbContext dbContext, IQueryVisitor visitor);
    IFromCommand<TEntity, T1, T2, T3, T4, T5, T6> NewFromCommand<TEntity, T1, T2, T3, T4, T5, T6>(DbContext dbContext, IQueryVisitor visitor);

    IGroupingCommand<TEntity, T, TGrouping> NewGroupCommand<TEntity, T, TGrouping>(DbContext dbContext, IQueryVisitor visitor);
    IGroupingCommand<TEntity, T1, T2, TGrouping> NewGroupCommand<TEntity, T1, T2, TGrouping>(DbContext dbContext, IQueryVisitor visitor);
    IGroupingCommand<TEntity, T1, T2, T3, TGrouping> NewGroupCommand<TEntity, T1, T2, T3, TGrouping>(DbContext dbContext, IQueryVisitor visitor);
    IGroupingCommand<TEntity, T1, T2, T3, T4, TGrouping> NewGroupCommand<TEntity, T1, T2, T3, T4, TGrouping>(DbContext dbContext, IQueryVisitor visitor);
    IGroupingCommand<TEntity, T1, T2, T3, T4, T5, TGrouping> NewGroupCommand<TEntity, T1, T2, T3, T4, T5, TGrouping>(DbContext dbContext, IQueryVisitor visitor);
    IGroupingCommand<TEntity, T1, T2, T3, T4, T5, T6, TGrouping> NewGroupCommand<TEntity, T1, T2, T3, T4, T5, T6, TGrouping>(DbContext dbContext, IQueryVisitor visitor);
    ...
    IMultiQuery<T1, T2, T3> NewMultiQuery<T1, T2, T3>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiQuery<T1, T2, T3, T4> NewMultiQuery<T1, T2, T3, T4>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiQuery<T1, T2, T3, T4, T5> NewMultiQuery<T1, T2, T3, T4, T5>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiQuery<T1, T2, T3, T4, T5, T6> NewMultiQuery<T1, T2, T3, T4, T5, T6>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiQuery<T1, T2, T3, T4, T5, T6, T7> NewMultiQuery<T1, T2, T3, T4, T5, T6, T7>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8> NewMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9> NewMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> NewMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> NewMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> NewMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> NewMultiQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    ...
    IMultiGroupingQuery<T1, T2, T3, TGrouping> NewMultiGroupingQuery<T1, T2, T3, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiGroupingQuery<T1, T2, T3, T4, TGrouping> NewMultiGroupingQuery<T1, T2, T3, T4, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiGroupingQuery<T1, T2, T3, T4, T5, TGrouping> NewMultiGroupingQuery<T1, T2, T3, T4, T5, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiGroupingQuery<T1, T2, T3, T4, T5, T6, TGrouping> NewMultiGroupingQuery<T1, T2, T3, T4, T5, T6, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, TGrouping> NewMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, TGrouping> NewMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, TGrouping> NewMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TGrouping> NewMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TGrouping> NewMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TGrouping> NewMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TGrouping> NewMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
    IMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TGrouping> NewMultiGroupingQuery<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, TGrouping>(IMultipleQuery multiQuery, IQueryVisitor visitor);
