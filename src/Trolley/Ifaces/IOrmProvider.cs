...
public interface IOrmProvider
{
    ...
    IFromCreated NewFromCreated(DbContext dbContext, ICreateVisitor visitor);
    IFromCreated<TEntity> NewFromCreated<TEntity>(DbContext dbContext, ICreateVisitor visitor);
