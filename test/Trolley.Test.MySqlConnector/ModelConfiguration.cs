...
class ModelConfiguration : IModelConfiguration
{
    public void OnModelCreating(ModelBuilder builder)
    {
        builder.Entity<Brand>(f =>
        {
            ...
            //f.Member(t => t.BrandNo).Field(nameof(Brand.BrandNo)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(2).MaxLength(50);
            //f.Member(t => t.Name).Field(nameof(Brand.Name)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(3).MaxLength(50);
        ...
        builder.Entity<Company>(f =>
        {
            ...
            //f.Member(t => t.Name).Field(nameof(Company.Name)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(2).MaxLength(50);
            //f.Member(t => t.Nature).Field(nameof(Company.Nature)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(3).MaxLength(50);
        ...
        builder.Entity<Function>(f =>
        {
            ...
            //f.Member(t => t.FunctionName).Field(nameof(Function.FunctionName)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(3).MaxLength(50);
            //f.Member(t => t.Description).Field(nameof(Function.Description)).DbColumnType("varchar(500)").NativeDbType(MySqlDbType.VarChar).Position(4).MaxLength(500);
        ...
        builder.Entity<Menu>(f =>
        {
            ...
            //f.Member(t => t.Name).Field(nameof(Menu.Name)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(2).MaxLength(50);
        ...
        builder.Entity<Order>(f =>
        {
            ...
            //f.Member(t => t.Id).Field(nameof(Order.Id)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(1).MaxLength(50).Required();
            //f.Member(t => t.TenantId).Field(nameof(Order.TenantId)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(2).MaxLength(50).Required();
            //f.Member(t => t.OrderNo).Field(nameof(Order.OrderNo)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(3).MaxLength(50);
            ...
            //f.Member(t => t.BuyerSource).Field(nameof(Order.BuyerSource)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(7).MaxLength(50);
        ...
        builder.Entity<OrderDetail>(f =>
        {
            ...
            //f.Member(t => t.Id).Field(nameof(OrderDetail.Id)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(1).MaxLength(50).Required();
            //f.Member(t => t.TenantId).Field(nameof(OrderDetail.TenantId)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(2).MaxLength(50).Required();
            //f.Member(t => t.OrderId).Field(nameof(OrderDetail.OrderId)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(3).MaxLength(50);
        ...
        builder.Entity<Page>(f =>
        {
            ...
            f.Member(t => t.Url).Field(nameof(Page.Url)).DbColumnType("varchar(200)").NativeDbType(MySqlDbType.VarChar).Position(2).MaxLength(200);
        ...
        builder.Entity<Product>(f =>
        {
            ...
            f.Member(t => t.ProductNo).Field(nameof(Product.ProductNo)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(2).MaxLength(50);
            f.Member(t => t.Name).Field(nameof(Product.Name)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(3).MaxLength(50);
        ...
        builder.Entity<UpdateEntity>(f =>
        {
            ...
            f.Member(t => t.GuidField).Field(nameof(UpdateEntity.GuidField)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(4).MaxLength(50);
        ...
        builder.Entity<User>(f =>
        {
            ...
            f.Member(t => t.TenantId).Field(nameof(User.TenantId)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(2).MaxLength(50).Required();
            f.Member(t => t.Name).Field(nameof(User.Name)).DbColumnType("varchar(50)").NativeDbType(MySqlDbType.VarChar).Position(3).MaxLength(50);
