...
public class NpgsqlUnitTest2
{
    private readonly IOrmDbFactory dbFactory;
    public NpgsqlUnitTest2()
    {
    ...
    public async void FromQuery_InnerJoin1()
    {
        ...
        var result = await repository.From<User>()
                ...
                .InnerJoin(f => f.From<OrderDetail>()
                    .GroupBy(x => x.OrderId)
                    .Select((x, y) => new { y.OrderId, ProductCount = x.CountDistinct(y.ProductId) })
    ...
    public void FromQuery_Ignore_Include()
    {
        ...
        var sql = repository.From<User>()
            ...
            .ToSql(out _);
        Assert.True(sql == "SELECT a.\"Id\",a.\"Name\",(b.\"CreatedAt\")::DATE,COUNT(b.\"Id\") AS OrderCount,SUM(b.\"TotalAmount\") AS TotalAmount FROM \"sys_user\" a INNER JOIN \"sys_order\" b ON a.\"Id\"=b.\"BuyerId\" GROUP BY a.\"Id\",a.\"Name\",(b.\"CreatedAt\")::DATE ORDER BY a.\"Id\",a.\"Name\",(b.\"CreatedAt\")::DATE");
    }
    [Fact]
    ...
    public void FromQuery_Groupby_OrderBy_Fields()
    {
        ...
        var sql = repository.From<User>()
           ...
           .ToSql(out _);
        Assert.True(sql == "SELECT a.\"Id\",a.\"Name\",(b.\"CreatedAt\")::DATE,COUNT(b.\"Id\") AS OrderCount,SUM(b.\"TotalAmount\") AS TotalAmount FROM \"sys_user\" a INNER JOIN \"sys_order\" b ON a.\"Id\"=b.\"BuyerId\" GROUP BY a.\"Id\",a.\"Name\",(b.\"CreatedAt\")::DATE ORDER BY a.\"Id\",a.\"Name\" DESC,(b.\"CreatedAt\")::DATE");
    }
    [Fact]
