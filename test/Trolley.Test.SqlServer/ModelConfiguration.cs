...
class ModelConfiguration : IModelConfiguration
{
    public void OnModelCreating(ModelBuilder builder)
    {
        builder.Entity<Brand>(f =>
        {
            ...
            f.Member(t => t.BrandNo).Field(nameof(Brand.BrandNo)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(2).MaxLength(50);
            f.Member(t => t.Name).Field(nameof(Brand.Name)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(3).MaxLength(50);
        ...
        builder.Entity<Company>(f =>
        {
            ...
            f.Member(t => t.Name).Field(nameof(Company.Name)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(2).MaxLength(50);
            f.Member(t => t.Nature).Field(nameof(Company.Nature)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(3).MaxLength(50);
        ...
        builder.Entity<Function>(f =>
        {
            ...
            f.Member(t => t.FunctionName).Field(nameof(Function.FunctionName)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(3).MaxLength(50);
            f.Member(t => t.Description).Field(nameof(Function.Description)).DbColumnType("nvarchar(500)").NativeDbType(SqlDbType.NVarChar).Position(4).MaxLength(500);
        ...
        builder.Entity<Menu>(f =>
        {
            ...
            f.Member(t => t.Name).Field(nameof(Menu.Name)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(2).MaxLength(50);
        ...
        builder.Entity<Order>(f =>
        {
            ...
            f.Member(t => t.Id).Field(nameof(Order.Id)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(1).MaxLength(50).Required();
            f.Member(t => t.TenantId).Field(nameof(Order.TenantId)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(2).MaxLength(50).Required();
            f.Member(t => t.OrderNo).Field(nameof(Order.OrderNo)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(3).MaxLength(50);
            ...
            f.Member(t => t.BuyerSource).Field(nameof(Order.BuyerSource)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(7).MaxLength(50);
        ...
        builder.Entity<OrderDetail>(f =>
        {
            ...
            f.Member(t => t.Id).Field(nameof(OrderDetail.Id)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(1).MaxLength(50).Required();
            f.Member(t => t.TenantId).Field(nameof(OrderDetail.TenantId)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(2).MaxLength(50).Required();
            f.Member(t => t.OrderId).Field(nameof(OrderDetail.OrderId)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(3).MaxLength(50);
        ...
        builder.Entity<Page>(f =>
        {
            ...
            f.Member(t => t.Url).Field(nameof(Page.Url)).DbColumnType("nvarchar(200)").NativeDbType(SqlDbType.NVarChar).Position(2).MaxLength(200);
        ...
        builder.Entity<Product>(f =>
        {
            ...
            f.Member(t => t.ProductNo).Field(nameof(Product.ProductNo)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(2).MaxLength(50);
            f.Member(t => t.Name).Field(nameof(Product.Name)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(3).MaxLength(50);
        ...
        builder.Entity<UpdateEntity>(f =>
        {
            ...
            f.Member(t => t.GuidField).Field(nameof(UpdateEntity.GuidField)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(4).MaxLength(50);
        ...
        builder.Entity<User>(f =>
        {
            ...
            f.Member(t => t.TenantId).Field(nameof(User.TenantId)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(2).MaxLength(50).Required();
            f.Member(t => t.Name).Field(nameof(User.Name)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(3).MaxLength(50);
            f.Member(t => t.Gender).Field(nameof(User.Gender)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(4).MaxLength(50);
            ...
            f.Member(t => t.SourceType).Field(nameof(User.SourceType)).DbColumnType("nvarchar(50)").NativeDbType(SqlDbType.NVarChar).Position(9).MaxLength(50);
