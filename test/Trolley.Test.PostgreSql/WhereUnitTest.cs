...
public class WhereUnitTest : UnitTestBase
{
    ...
    public void WhereAndOr()
    {
        ...
        sql = repository.From<Order, User>()
            ...
            .Select((a, b) => "*")
        .ToSql(out _);
        Assert.AreEqual("SELECT * FROM \"sys_order\" a,\"sys_user\" b WHERE (a.\"BuyerId\"=b.\"Id\" OR b.\"SourceType\"='Douyin') AND (a.\"BuyerSource\"='Taobao' OR (a.\"SellerId\" IS NULL AND a.\"ProductCount\" IS NULL) OR a.\"ProductCount\">1 OR (a.\"TotalAmount\">500 AND a.\"BuyerSource\"='Website')) AND ((a.\"BuyerId\"<=10 AND a.\"ProductCount\">5 AND b.\"SourceType\"='Douyin') OR (a.\"BuyerId\">10 AND a.\"ProductCount\"<=5 AND b.\"SourceType\"='Website') OR a.\"BuyerSource\"='Taobao') AND a.\"IsEnabled\"=TRUE AND a.\"BuyerId\"=b.\"Id\" AND (a.\"Products\" IS NULL OR a.\"Disputes\" IS NULL)", sql);
    }
    [Test]
    public void Where()
    {
