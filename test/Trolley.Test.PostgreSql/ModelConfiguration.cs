...
class ModelConfiguration : IModelConfiguration
{
    public void OnModelCreating(ModelBuilder builder)
    {
        builder.Entity<Brand>(f =>
        {
            ...
            f.Member(t => t.CreatedAt).Field(nameof(Brand.CreatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(6);
            f.Member(t => t.CreatedBy).Field(nameof(Brand.CreatedBy)).DbColumnType("int4").NativeDbType(NpgsqlDbType.Integer).Position(7);
            f.Member(t => t.UpdatedAt).Field(nameof(Brand.UpdatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(8);
        ...
        builder.Entity<Company>(f =>
        {
            ...
            f.Member(t => t.Id).Field(nameof(Company.Id)).DbColumnType("int4").NativeDbType(NpgsqlDbType.Integer).Position(1).AutoIncrement().Required();
            ...
            f.Member(t => t.CreatedAt).Field(nameof(Company.CreatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(5);
            f.Member(t => t.CreatedBy).Field(nameof(Company.CreatedBy)).DbColumnType("int4").NativeDbType(NpgsqlDbType.Integer).Position(6);
            f.Member(t => t.UpdatedAt).Field(nameof(Company.UpdatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(7);
        ...
        builder.Entity<Function>(f =>
        {
            ...
            f.Member(t => t.CreatedAt).Field(nameof(Function.CreatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(6);
            f.Member(t => t.CreatedBy).Field(nameof(Function.CreatedBy)).DbColumnType("int4").NativeDbType(NpgsqlDbType.Integer).Position(7);
            f.Member(t => t.UpdatedAt).Field(nameof(Function.UpdatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(8);
        ...
        builder.Entity<Menu>(f =>
        {
            ...
            f.Member(t => t.CreatedAt).Field(nameof(Menu.CreatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(6);
            f.Member(t => t.CreatedBy).Field(nameof(Menu.CreatedBy)).DbColumnType("int4").NativeDbType(NpgsqlDbType.Integer).Position(7);
            f.Member(t => t.UpdatedAt).Field(nameof(Menu.UpdatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(8);
        ...
        builder.Entity<Order>(f =>
        {
            ...
            f.Member(t => t.TotalAmount).Field(nameof(Order.TotalAmount)).DbColumnType("float8").NativeDbType(NpgsqlDbType.Double).Position(5);
            ...
            //特殊类型JSON
            f.Member(t => t.Products).Field(nameof(Order.Products)).DbColumnType("jsonb").NativeDbType(NpgsqlDbType.Jsonb).Position(9).TypeHandler<JsonTypeHandler>();
            f.Member(t => t.Disputes).Field(nameof(Order.Disputes)).DbColumnType("jsonb").NativeDbType(NpgsqlDbType.Jsonb).Position(10).TypeHandler<JsonTypeHandler>();
            f.Member(t => t.IsEnabled).Field(nameof(Order.IsEnabled)).DbColumnType("bool").NativeDbType(NpgsqlDbType.Boolean).Position(11);
            f.Member(t => t.CreatedAt).Field(nameof(Order.CreatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(12);
            f.Member(t => t.CreatedBy).Field(nameof(Order.CreatedBy)).DbColumnType("int4").NativeDbType(NpgsqlDbType.Integer).Position(13);
            f.Member(t => t.UpdatedAt).Field(nameof(Order.UpdatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(14);
        ...
        builder.Entity<OrderDetail>(f =>
        {
            ...
            f.Member(t => t.Price).Field(nameof(OrderDetail.Price)).DbColumnType("float8").NativeDbType(NpgsqlDbType.Double).Position(5);
            f.Member(t => t.Quantity).Field(nameof(OrderDetail.Quantity)).DbColumnType("int4").NativeDbType(NpgsqlDbType.Integer).Position(6);
            f.Member(t => t.Amount).Field(nameof(OrderDetail.Amount)).DbColumnType("float8").NativeDbType(NpgsqlDbType.Double).Position(7);
            f.Member(t => t.IsEnabled).Field(nameof(OrderDetail.IsEnabled)).DbColumnType("bool").NativeDbType(NpgsqlDbType.Boolean).Position(8);
            f.Member(t => t.CreatedAt).Field(nameof(OrderDetail.CreatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(9);
            ...
            f.Member(t => t.UpdatedAt).Field(nameof(OrderDetail.UpdatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(11);
        ...
        builder.Entity<Page>(f =>
        {
            ...
            f.Member(t => t.CreatedAt).Field(nameof(Page.CreatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(4);
            f.Member(t => t.CreatedBy).Field(nameof(Page.CreatedBy)).DbColumnType("int4").NativeDbType(NpgsqlDbType.Integer).Position(5);
            f.Member(t => t.UpdatedAt).Field(nameof(Page.UpdatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(6);
        ...
        builder.Entity<Product>(f =>
        {
            ...
            f.Member(t => t.Price).Field(nameof(Product.Price)).DbColumnType("float8").NativeDbType(NpgsqlDbType.Double).Position(6);
            ...
            f.Member(t => t.CreatedAt).Field(nameof(Product.CreatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(9);
            f.Member(t => t.CreatedBy).Field(nameof(Product.CreatedBy)).DbColumnType("int4").NativeDbType(NpgsqlDbType.Integer).Position(10);
            f.Member(t => t.UpdatedAt).Field(nameof(Product.UpdatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(11);
        ...
        builder.Entity<UpdateEntity>(f =>
        {
            ...
            f.Member(t => t.EnumField).Field(nameof(UpdateEntity.EnumField)).DbColumnType("int2").NativeDbType(NpgsqlDbType.Smallint).Position(3);
            f.Member(t => t.GuidField).Field(nameof(UpdateEntity.GuidField)).DbColumnType("varchar(50)").NativeDbType(NpgsqlDbType.Varchar).Position(4).Length(50);
            f.Member(t => t.DateTimeField).Field(nameof(UpdateEntity.DateTimeField)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(5);
            ...
            f.Member(t => t.DateTimeOffsetField).Field(nameof(UpdateEntity.DateTimeOffsetField)).DbColumnType("timestamptz").NativeDbType(NpgsqlDbType.TimestampTz).Position(7);
            f.Member(t => t.TimeSpanField).Field(nameof(UpdateEntity.TimeSpanField)).DbColumnType("interval").NativeDbType(NpgsqlDbType.Interval).Position(8);
        ...
        builder.Entity<User>(f =>
        {
            ...
            f.Member(t => t.TenantId).Field(nameof(User.TenantId)).DbColumnType("varchar(50)").NativeDbType(NpgsqlDbType.Varchar).Position(2).Length(50).Required();
            ...
            f.Member(t => t.CreatedAt).Field(nameof(User.CreatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(11);
            f.Member(t => t.CreatedBy).Field(nameof(User.CreatedBy)).DbColumnType("int4").NativeDbType(NpgsqlDbType.Integer).Position(12);
            f.Member(t => t.UpdatedAt).Field(nameof(User.UpdatedAt)).DbColumnType("timestamp").NativeDbType(NpgsqlDbType.Timestamp).Position(13);
            f.Member(t => t.UpdatedBy).Field(nameof(User.UpdatedBy)).DbColumnType("int4").NativeDbType(NpgsqlDbType.Integer).Position(14);
