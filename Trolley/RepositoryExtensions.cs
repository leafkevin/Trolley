...
namespace Trolley
{
    public static class RepositoryExtensions
    {
        ...
        {
            var sqlBuilder = new SqlBuilder(repository.Provider);
        ...
        public static PagedList<TEntity> QueryPage<TEntity>(this IRepository repository, Action<SqlBuilder> builder, int pageIndex, int pageSize, string orderBy = null, object objParameter = null)
        {
            var sqlBuilder = new SqlBuilder(repository.Provider);
            builder.Invoke(sqlBuilder);
