...
//    private List<TableSegment> fromTables = new();
//    private List<ReaderFieldInfo> readerFields;
//    private bool hasScope = false;
//    private SqlSegmentType sqlType = SqlSegmentType.None;
...
//    }
//    public string BuildSql(out List<IDbDataParameter> dbParameters, out List<ReaderFieldInfo> readerFields)
//    {
//        switch (this.sqlType)
//        {
//            case SqlSegmentType.Select:
//                return this.BuildSelectSql(out dbParameters, out readerFields);
//            case SqlSegmentType.Insert:
//                return this.BuildInsertSql(out dbParameters, out readerFields);
//            case SqlSegmentType.Update:
//                return this.BuildUpdateSql(out dbParameters, out readerFields);
//            case SqlSegmentType.Delete:
//                return this.BuildDeleteSql(out dbParameters, out readerFields);
//        }
//        dbParameters = null;
//        readerFields = null;
//        return null;
//    }
//    public SqlExpressionVisitor From(Type tableType, SqlSegmentType sqlType = SqlSegmentType.Select, string joinType = "")
//    {
//        this.sqlType = sqlType;
//        char tableIndex = 'a';
//        tableIndex += (char)this.fromTables.Count;
//        var tableInfo = new TableSegment
//        {
//            EntityType = tableType,
//            AlaisName = $"{tableIndex}",
//            NodeType = joinType
//        };
//        this.fromTables.Add(tableInfo);
//        return this;
//    }
//    private TableSegment TryAddTable(Type entityType, EntityMap mapper)
//    {
...
//    }
//    private TableSegment TryAddTable(Type entityType, string joinType = "")
//    {
...
//        return tableInfo;
//    }
//    public SqlExpressionVisitor Include(Expression includeExpr)
//    {
//        this.hasScope = false;
...
//    {
//        this.hasScope = false;
//        var joinTableInfo = this.TryAddTable(entityType, joinType);
//        if (joinExpr != null)
//        {
//            var sqlSegment = this.Visit(joinExpr) as SqlSegment;
//            sqlSegment = this.VisitBooleanDeferredMember(sqlSegment);
//            if (string.IsNullOrEmpty(joinTableInfo.OnExpr))
//                joinTableInfo.OnExpr = sqlSegment.ToString();
//        }
//        return this;
//    }
//    public SqlExpressionVisitor Select(string selectSql)
//    {
...
//        return this;
//    }
//    public SqlExpressionVisitor Page(int pageIndex, int pageSize)
//    {
...
//        return this;
//    }
//    public SqlExpressionVisitor Skip(int skip)
//    {
//        this.skip = skip;
//        return this;
//    }
//    public SqlExpressionVisitor Take(int limit)
//    {
//        this.limit = limit;
//        return this;
//    }
...
//        return this;
//    }
//    public SqlExpressionVisitor Distinct(Expression expr)
//    {
//        var sqlSegment = this.Visit(expr);
//        this.orderBySql += sqlSegment.ToString();
//        return this;
//    }
//    private string BuildSelectSql(out List<IDbDataParameter> dbParameters, out List<ReaderFieldInfo> readerFields)
//    {
//        if (string.IsNullOrEmpty(this.selectSql))
//            throw new Exception("没有select子句");
...
//        {
//            foreach (var tableInfo in this.fromTables)
//            {
...
//                builder.Append($"{tableInfo.NodeType} {tableInfo.Mapper.TableName} {tableInfo.AlaisName}");
...
//    }
//    private string BuildInsertSql(out List<IDbDataParameter> dbParameters, out List<ReaderFieldInfo> readerFields)
//    {
//        dbParameters = null;
//        readerFields = null;
//        return null;
//    }
//    private string BuildUpdateSql(out List<IDbDataParameter> dbParameters, out List<ReaderFieldInfo> readerFields)
//    {
//        dbParameters = null;
//        readerFields = null;
//        return null;
//    }
//    private string BuildDeleteSql(out List<IDbDataParameter> dbParameters, out List<ReaderFieldInfo> readerFields)
//    {
//        dbParameters = null;
//        readerFields = null;
//        return null;
...
//                    TableSegment leftTableInfo = null, fromTableInfo = null;
...
//                            entityType = this.fromTables.First(f => f.JoinType == "FROM").EntityType;
...
//        return sqlSegment;
//    }
//    private void SetRightTableJoinOn(EntityMap entityMapper, TableSegment fromTableInfo, EntityMap leftMapper, TableSegment leftTableInfo, MemberMap leftMemberMapper)
//    {
//        //没有joinOn子句，只能是导航属性，如果未设置导航属性，会有InnerJoin,LeftJoin,RightJoin子句来指定
//        if (leftTableInfo != null && string.IsNullOrEmpty(fromTableInfo.OnExpr))
//        {
...
//            {
//                //1:1或是n:1
//                var navigationMapper = leftMapper.GetMemberMap(leftMemberMapper.ForeignKey);
...
//                var navigationMapper = entityMapper.GetMemberMap(leftMemberMapper.ForeignKey);
//                rightField = this.ormProvider.GetFieldName(navigationMapper.FieldName);
//            }
//            fromTableInfo.OnExpr = $"{leftTableInfo.AlaisName}.{leftField}={fromTableInfo.AlaisName}.{rightField}";
//        }
//    }
